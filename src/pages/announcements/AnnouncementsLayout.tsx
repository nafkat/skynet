      ...
      <aside className={cn(
        ...
        <div className="p-6 border-b border-sidebar-border">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {language === 'el' ? 'Ανακοινώσεις' : 'Announcements'}
          </p>
        </div>
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto scrollbar-thin">
          ...
          <Link
            to="/announcements"
            className={cn('nav-item', (location.pathname === '/announcements' || isActiveRoute('/announcements/dashboard', true)) && 'active')}
          >
          ...
          <Link
            ...
            className={cn('nav-item', isActiveRoute('/announcements/list') && 'active')}
          >
            <List className="h-5 w-5" />
            <span className="font-medium">
              {language === 'el' ? 'Όλες οι Ανακοινώσεις' : 'All Announcements'}
            </span>
          </Link>

          <Link
            to="/announcements/new"
            className={cn('nav-item', isActiveRoute('/announcements/new') && 'active')}
          >
            <Plus className="h-5 w-5" />
            <span className="font-medium">
              {language === 'el' ? 'Νέα Ανακοίνωση' : 'New Announcement'}
            </span>
          </Link>
        </nav>
