...
export const translations: Translations = {
  ...
  'timeEntry.multipleEmployees': { en: 'Multiple employees', el: 'Πολλαπλοί εργαζόμενοι' },
  'timeEntry.selectEmployees': { en: 'Select employees…', el: 'Επιλογή εργαζομένων…' },
  'timeEntry.searchEmployees': { en: 'Search employees…', el: 'Αναζήτηση εργαζομένων…' },
  'timeEntry.noEmployeesFound': { en: 'No employees found.', el: 'Δεν βρέθηκαν εργαζόμενοι.' },
  'timeEntry.selectAll': { en: 'Select all', el: 'Επιλογή όλων' },
  'timeEntry.clearSelection': { en: 'Clear', el: 'Καθαρισμός' },
  'timeEntry.selectedCount': { en: 'selected', el: 'επιλεγμένοι' },
  'timeEntry.bulkRegister': { en: 'Register for {count} employees', el: 'Καταχώρηση για {count} εργαζόμενους' },
  'timeEntry.bulkSuccess': { en: '{count} entries registered successfully', el: 'Καταχωρήθηκαν {count} εγγραφές' },
  'timeEntry.bulkOverlapTitle': { en: 'Cannot save: time overlaps detected', el: 'Δεν είναι δυνατή η αποθήκευση: εντοπίστηκαν επικαλύψεις' },
  'timeEntry.bulkOverlapDesc': { en: 'The following employees already have overlapping entries on this date. Resolve the conflicts or deselect them and try again.', el: 'Οι παρακάτω εργαζόμενοι έχουν ήδη καταχωρήσεις που επικαλύπτονται για αυτή την ημερομηνία. Επιλύστε τις συγκρούσεις ή αποεπιλέξτε τους και δοκιμάστε ξανά.' },
  'timeEntry.atLeastOneEmployee': { en: 'Select at least one employee', el: 'Επιλέξτε τουλάχιστον έναν εργαζόμενο' },
  'timeEntry.invalidPayRatesList': { en: 'These employees have incomplete pay rates and were skipped:', el: 'Οι παρακάτω εργαζόμενοι έχουν ελλιπείς αμοιβές και παρακάμφθηκαν:' },
  ...
  'reports.totalRegularPlusOT': { en: 'Total (Regular + OT)', el: 'Σύνολο (Κανονικά + Υπερωρίες)' },
  'reports.totalAllInPlusOT': { en: 'Total (All-in + OT)', el: 'Σύνολο (All-in + Υπερωρίες)' },
  'reports.totalOT': { en: 'Total (OT)', el: 'Σύνολο (Υπερωρίες)' },
