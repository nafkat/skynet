  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingProject) {
        ...
        // Upsert customer details FIRST so a permission/error here stops before
        // touching the project row.
        ...
        // Create flow: project row must exist first for the FK, then details.
          ...
          <div key={project.id} className="card-elevated p-6">
            ...
            <div className="space-y-2 mb-3 text-sm">
              <div className="flex items-center gap-2 text-muted-foreground">
                ...
                <span className="truncate">{customerDetails[project.id]?.customer_company_name || '—'}</span>
              </div>
